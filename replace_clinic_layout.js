...
const path = 'src/app/clinic/layout.jsx';
...
if (regex.test(content)) {
  ...
  console.log("Successfully replaced the clinic header layout left part!");
} else {
  console.error("Regex did not match anything in clinic layout.");
}
